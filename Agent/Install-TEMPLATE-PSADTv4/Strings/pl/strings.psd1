    ...
    CloseAppsPrompt = @{
        ...
        Fluent = @{
            ...
            DialogMessageNoProcesses = @{
                Install = 'Proszę wybrać Zainstaluj, aby kontynuować instalację.'
                Repair = 'Proszę wybrać Napraw, aby kontynuować naprawę.'
                Uninstall = 'Proszę wybrać Odinstaluj, aby kontynuować dezinstalację.'
            }
